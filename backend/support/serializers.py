...
class AdminSupportTicketSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SupportTicket
        fields = ['id', 'ticket_number', 'user_email', 'user_full_name', 'user_whatsapp_number', 'subject', 'message', 'status', 'admin_notes', 'admin_reply', 'is_read_by_user', 'created_at', 'updated_at']
